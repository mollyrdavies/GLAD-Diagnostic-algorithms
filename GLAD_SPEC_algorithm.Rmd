...
Calculate specific phobias count 'score' (the number of phobias endorsed)
...
SPEC.items <- SPEC.items %>% 
  mutate(specific_phobia_screener_numeric = 
           case_when(
             ...
             (spec.environment_phobia == "Yes" | spec.situation_phobia == "Yes" | spec.animal_phobia == "Yes" | spec.blood_injection_phobia == "Yes" | spec.other_phobia == "Yes") | is.na(spec.phobia_frequency) ~ NA_real_
           ))
