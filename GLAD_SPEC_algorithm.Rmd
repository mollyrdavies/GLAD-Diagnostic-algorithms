...
SPEC.items <- SPEC.items %>% 
  mutate(environment_phobia_diagnosis_numeric = 
           case_when(
...
SPEC.items <- SPEC.items %>% 
  mutate(environment_phobia_diagnosis =
           recode_factor(environment_phobia_diagnosis_numeric,
                         "0" = "No environment phobia",
                         "1" = "Environment phobia"))
#Situational phobia
SPEC.items <- SPEC.items %>% 
  mutate(situation_phobia_diagnosis_numeric = 
           case_when(
...
SPEC.items <- SPEC.items %>% 
  mutate(situation_phobia_diagnosis =
           recode_factor(situation_phobia_diagnosis_numeric,
                         "0" = "No situation phobia",
                         "1" = "Situation phobia"))
#Animal phobia
SPEC.items <- SPEC.items %>% 
  mutate(animal_phobia_diagnosis_numeric = 
           case_when(
...
SPEC.items <- SPEC.items %>% 
  mutate(animal_phobia_diagnosis =
           recode_factor(animal_phobia_diagnosis_numeric,
                         "0" = "No animal phobia",
                         "1" = "Animal phobia"))
#Blood injection phobia
SPEC.items <- SPEC.items %>% 
  mutate(blood_injection_phobia_diagnosis_numeric = 
           case_when(
...
SPEC.items <- SPEC.items %>% 
  mutate(blood_injection_phobia_diagnosis =
           recode_factor(blood_injection_phobia_diagnosis_numeric,
                         "0" = "No blood or injection phobia",
                         "1" = "Blood or injection phobia"))
#Other phobia
SPEC.items <- SPEC.items %>% 
  mutate(other_phobia_diagnosis_numeric = 
           case_when(
...
SPEC.items <- SPEC.items %>% 
  mutate(other_phobia_diagnosis =
           recode_factor(other_phobia_diagnosis_numeric,
                         "0" = "No other phobia",
                         "1" = "Other phobia"))
```
## NOTE: need to rename the following variables to have spec. infront of them for consistency environment_phobia_diagnosis_numeric, environment_phobia_diagnosis, animal_phobia_diagnosis_numeric, animal_phobia_diagnosis, blood_injection_phobia_diagnosis_numeric, blood_injection_phobia_diagnosis, other_phobia_diagnosis_numeric, other_phobia_diagnosis
...
#from environment_phobia_diagnosis_numeric onwards missing .spec in front of them 
