...
dat.cc$ClinicianMDD <- recode_factor(dat.cc$mhd.mdd,
                                            "0" = "No MDD diagnosis",
                                            "1" = "MDD diagnosis",
                                            "-77" = NULL,
                                            "-88" = NULL,
...
dat.cc$ClinicianGAD <- recode_factor(dat.cc$mhd.gad,
                                            "0" = "No GAD diagnosis",
                                            "1" = "GAD diagnosis",
                                            "-77" = NULL,
                                            "-88" = NULL,
...
dat.cc$ClinicianSpecPhob <- recode_factor(dat.cc$mhd.specific_phobia,
...
dat.cc$ClinicianSocialPhob <- recode_factor(dat.cc$mhd.social_anxiety,
...
dat.cc$ClinicianPanicDis <- recode_factor(dat.cc$mhd.panic_disorder,
...
dat.cc$ClinicianPanicAttacks <- recode_factor(dat.cc$mhd.panic_attacks,
...
dat.cc$ClinicianAgoraphobia <- recode_factor(dat.cc$mhd.agoraphobia,
...
dat.cc <- dat.cc %>% 
  mutate(ClinicianAnyAnx.n =
           case_when(
             mhd.gad == 0 & 
               mhd.specific_phobia == 0 & mhd.social_anxiety == 0 &
               mhd.panic_disorder == 0 & mhd.agoraphobia == 0 ~ 0,
             mhd.gad == 1 | mhd.specific_phobia == 1 | 
               mhd.social_anxiety == 1 |
               mhd.panic_disorder == 1 | mhd.agoraphobia == 1 ~ 1
           ),
         LifetimeAnyAnx.n = 
           case_when(
