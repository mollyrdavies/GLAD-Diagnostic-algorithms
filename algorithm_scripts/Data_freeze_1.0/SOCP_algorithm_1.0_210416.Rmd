...
This script runs an algorithm based on DSM-5 diagnostic criteria, to ascertain likely lifetime diagnosis of social anxiety disorder (previously social phobia) using the GLAD and COPING NBR data.
