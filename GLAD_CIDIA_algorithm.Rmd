...
#Set value for months or years variable to zero if the other contains a value
...
CIDIA.months.years<-CIDIA.months.years%>%
  mutate(cidia.longest_period_worry_months.years =
           if_else(is.na(cidia.longest_period_worry_months.years) & is.na(cidia.longest_period_worry_years), NA_real_,
                   if_else(is.na(cidia.longest_period_worry_months.years) & !is.na(cidia.longest_period_worry_years), 0, cidia.longest_period_worry_months.years)),
         cidia.longest_period_worry_years = 
           if_else(is.na(cidia.longest_period_worry_years) & is.na(cidia.longest_period_worry_months.years), NA_real_,
                   if_else(is.na(cidia.longest_period_worry_years) & !is.na(cidia.longest_period_worry_months.years), 0, cidia.longest_period_worry_years)))
