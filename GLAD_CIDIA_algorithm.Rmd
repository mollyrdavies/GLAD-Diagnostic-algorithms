...
CIDIA.items <- CIDIA.items %>% 
  mutate(cidia.screener_numeric_test = 
           case_when(
...
Note: Duration is not included here, as the screener variable accounts for those responses.
...
CIDIA.items <- CIDIA.items %>% 
  mutate(cidia.criterion_B_numeric = 
           case_when(
             cidia.difficult_to_stop == "No" & 
               (cidia.couldnt_stop == "Never" | cidia.couldnt_stop == "Rarely" | cidia.couldnt_stop == "Sometimes") & 
               (cidia.difficult_to_control == "Never" | cidia.difficult_to_control == "Rarely" | cidia.difficult_to_control == "Sometimes") ~ 0,
             cidia.difficult_to_stop == "Yes" | cidia.couldnt_stop == "Often" | cidia.difficult_to_control == "Often" ~ 1
           ))
...
CIDIA.items <- CIDIA.items %>% 
  mutate(cidia.restless_on_edge =
           case_when(
             cidia.restless == "No" & cidia.on_edge == "No" ~ 0,
             cidia.restless == "Yes" | cidia.on_edge == "Yes" ~ 1
           ))
...
CIDIA.items <- CIDIA.items %>% 
  mutate(cidia.criterion_D_numeric =
           case_when(
             cidia.functioning == "Not at all" | cidia.functioning == "A little" ~ 0,
             cidia.functioning == "A lot" | cidia.functioning == "Some" ~ 1
           ))
...
CIDIA.items$cidia.criterion_A_score_numeric.NA<-0

CIDIA.items$cidia.criterion_A_score_numeric.NA<-with(CIDIA.items, 
                                    ifelse(is.na(cidia.restless_on_edge), 
                                           cidia.criterion_A_score_numeric.NA + 1, cidia.criterion_A_score_numeric.NA))
...
summary(as.factor(CIDIA.items$cidia.criterion_A_score_numeric.NA))
...
$cidia.lifetime_anxiety.calc <- with(CIDIA.items,
                                                      ifelse(
                                                        no.info > 0, NA,
                                                        ifelse((!is.na(cidia.criterion_A_score_numeric) & cidia.criterion_A_score_numeric > 2)
...
CIDIA.items$cidia.lifetime_anxiety.calc <- with(CIDIA.items,
                                                      ifelse(cidia.criterion_A_score_numeric == 2 & cidia.criterion_A_score_numeric.NA > 0,
                                                             NA, cidia.lifetime_anxiety.calc))

CIDIA.items$cidia.lifetime_anxiety.calc <- with(CIDIA.items,
                                                      ifelse(cidia.criterion_A_score_numeric == 1 & cidia.criterion_A_score_numeric.NA > 1,
                                                             NA, cidia.lifetime_anxiety.calc))

CIDIA.items$cidia.lifetime_anxiety.calc <- with(CIDIA.items,
                                                      ifelse(cidia.criterion_A_score_numeric == 0 & cidia.criterion_A_score_numeric.NA > 2,
                                                             NA, cidia.lifetime_anxiety.calc))
...
CIDIA <- CIDIA.items[,c("ID", "cidia.anxiety_screen.calc", "cidia.restless_on_edge", "cidia.criterion_A_score_numeric", "cidia.criterion_A_score_numeric.NA", "cidia.lifetime_anxiety.calc")]
...
CIDIA.clean <- CIDIA.cc %>%
  select(ID,
        ...
        cidia.criterion_A_score_numeric,
        cidia.criterion_A_score_numeric.NA,
        cidia.diagnosis,
