...
#Create clinician any anxiety variable
dat.cc$ClinicianAnyAnx.n <- if_else(dat.cc$ClinicianGAD == "GAD diagnosis" | dat.cc$ClinicianSpecPhob == "Specific phobia diagnosis" | dat.cc$ClinicianSocialPhob == "Social phobia diagnosis" | dat.cc$ClinicianPanicDis == "Panic disorder diagnosis" | dat.cc$ClinicianAgoraphobia == "Agoraphobia diagnosis", 1, 0)

#Recode clinician any anxiety as factor
dat.cc$ClinicianAnyAnx <- recode_factor(dat.cc$ClinicianAnyAnx.n,
                                        "0" = "No anxiety diagnosis",
                                        "1" = "Any anxiety diagnosis",
                                        .missing = NULL)

#Check it worked (NOTE: NA are people with no other self-reported anxiety disorders, and an NA in self-reported panic disorder)
summary(dat.cc$ClinicianAnyAnx)

#Create lifetime any anxiety variable
dat.cc$LifetimeAnyAnx.n <- if_else_(dat.cc$LifetimeGAD == "Lifetime GAD" | dat.cc$SpecificPhobia == "Lifetime specific phobia" | dat.cc$SocialPhobia == "Lifetime social phobia" | dat.cc$PanicDisorder == "Lifetime panic disorder" | dat.cc$Agoraphobia == "Lifetime agoraphobia", 1, 0)

#Recode lifetime any anxiety as factor
dat.cc$LifetimeAnyAnx <- recode_factor(dat.cc$LifetimeAnyAnx.n,
                                        "0" = "Never had anxiety",
                                        "1" = "Lifetime any anxiety")

#Check it worked
summary(dat.cc$LifetimeAnyAnx)
