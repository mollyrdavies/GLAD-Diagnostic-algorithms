...
$cidid.screener_numeric <- with(CIDID.items,
                                                    ifelse(
                                                      (cidid.low_mood == "Yes" | cidid.anhedonia == "Yes"),
                                                      1, 0
                                                    ))

summary(as.factor(CIDID.items$cidid.screener_numeric))
...
CIDID.items$cidid.weight_appetite_change.calc <- NA
CIDID.items$cidid.weight_appetite_change.calc <- with(CIDID.items,
                                                    ifelse(
...
summary(as.factor(CIDID.items$cidid.weight_appetite_change.calc))
...
CIDID.items$cidid.lifetime_depression_total.calc<-0

#Criterion A.1 - low mood
CIDID.items$cidid.lifetime_depression_total.calc<-with(CIDID.items, 
...
summary(as.factor(CIDID.items$cidid.lifetime_depression_total.calc))
...
CIDID.items$cidid.lifetime_depression_total.calc.NA<-0

CIDID.items$cidid.lifetime_depression_total.calc.NA<-with(CIDID.items, 
                                    ifelse(is.na(cidid.low_mood), 
...
summary(as.factor(CIDID.items$cidid.lifetime_depression_total.calc.NA))
...
CIDI.dep <- CIDID.items[,c("ID", "cidid.depression_screen.calc", "cidid.weight_appetite_change.calc", "cidid.lifetime_depression_total.calc", "cidid.lifetime_depression_total.calc.NA", "cidid.lifetime_depression")]
