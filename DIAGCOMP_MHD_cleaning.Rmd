...
Cleaning script for the mental health diagnoses (MHD) section of the GLAD Study data for the paper:
"Comparison of algorithm-based versus single-item phenotyping measures of depression and anxiety disorders in the GLAD Study cohort" Davies et al (in prep)
